  ...
  return (
    <div className="pricing-page">
      <div className="pricing-layout">
        ...
        <div className="pricing-content-side">
          <div className="pricing-container">
            ...
            <section className="pricing-section">
              <h2>Cake Flowers</h2>
              <div className="pricing-list">
                <div className="pricing-item"><span>Cake Meadow</span><span className="price">$300+</span></div>
                <div className="pricing-item"><span>Cake Flowers</span><span className="price">$30+</span></div>
              </div>
            </section>
            ...
            <section className="pricing-section">
              <h2>Centerpieces</h2>
              <div className="pricing-list">
                <div className="pricing-item"><span>Large Centerpieces</span><span className="price">$170+</span></div>
                <div className="pricing-item"><span>Small Centerpieces</span><span className="price">$75+</span></div>
                <div className="pricing-item"><span>Bud Vases</span><span className="price">$7 each</span></div>
              </div>
            </section>
        ...
        </div>{/* end pricing-content-side */}

        {/* RIGHT: images */}
        <div className="pricing-images">
          <div className="side-img-frame">
            <img src="/images/PricingImages/pricing1.JPG" alt="" />
          </div>
          <div className="side-img-frame">
            <img src="/images/PricingImages/pricing2.jpg" alt="" />
          </div>
          <div className="side-img-frame">
            <img src="/images/PricingImages/pricing3.JPG" alt="" />
          </div>
        </div>
